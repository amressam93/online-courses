            ...
            <div class="sliderThird">
                <div class="item">
                    ...
                    <div class="card  mb-4 card-hover">
                        <a href="pages/course-single.html" class="card-img-top"><img src="{{URL::asset('website/assets/images/course/course-react.jpg')}}" alt="" class="card-img-top rounded-top-md">
                        </a>
                        <!-- Card Body -->
                        <div class="card-body">
                ...
                <div class="item">
                    <!-- Card -->
                    <div class="card  mb-4 card-hover">
                        <a href="pages/course-single.html" class="card-img-top"><img src="{{URL::asset('website/assets/images/course/course-graphql.jpg')}}" alt="" class="card-img-top rounded-top-md"></a>
                        <!-- Card Body -->
                        <div class="card-body">
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                        ...
                        <div class="card-footer">
                            <div class="row align-items-center g-0">
                                <div class="col-auto">
                                    <img src="{{URL::asset('website/assets/images/avatar/avatar-10.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                </div>
                                <div class="col ms-2">
