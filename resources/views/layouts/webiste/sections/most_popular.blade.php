            ...
            <div class="sliderSecond">
                <div class="item">
                    ...
                    <div class="card  mb-4 card-hover">
                        <a href="pages/course-single.html" class="card-img-top"><img src="{{URL::asset('website/assets/images/course/course-gatsby.jpg')}}" alt="" class="card-img-top rounded-top-md"></a>
                        <!-- Card Body -->
                        <div class="card-body">
                ...
                <div class="item">
                    <!-- Card -->
                    <div class="card  mb-4 card-hover">
                        <a href="pages/course-single.html" class="card-img-top"><img src="{{URL::asset('website/assets/images/course/course-javascript.jpg')}}" alt="" class="card-img-top rounded-top-md"></a>
                        <!-- Card Body -->
                        <div class="card-body">
                ...
                <div class="item">
                    <!-- Card -->
                    <div class="card  mb-4 card-hover">
                        <a href="pages/course-single.html" class="card-img-top"><img src="{{URL::asset('website/assets/images/course/course-css.jpg')}}" alt="" class="card-img-top rounded-top-md"></a>
                        <!-- Card Body -->
                        <div class="card-body">
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                        ...
                        <div class="card-footer">
                            <div class="row align-items-center g-0">
                                <div class="col-auto">
                                    <img src="{{URL::asset('website/assets/images/avatar/avatar-7.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                </div>
                                <div class="col ms-2">
                ...
                <div class="item">
                    <!-- Card -->
                    <div class="card  mb-4 card-hover">
                        <a href="pages/course-single.html" class="card-img-top"><img src="{{URL::asset('website/assets/images/course/course-wordpress.jpg')}}" alt="" class="card-img-top rounded-top-md"></a>
                        <!-- Card Body -->
                        <div class="card-body">
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                        ...
                        <div class="card-footer">
                            <div class="row align-items-center g-0">
                                <div class="col-auto">
                                    <img src="{{URL::asset('website/assets/images/avatar/avatar-8.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                </div>
                                <div class="col ms-2">
