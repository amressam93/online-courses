...
@section('content')
    @include('admin.users.partials.header', ['title' => __('Update Video')])
                        ...
                        <form method="post" action="{{ route('videos.update',$video) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('Video Title') }}" value="{{ old('title',$video->title) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="link" id="input-link" class="form-control form-control-alternative{{ $errors->has('link') ? ' is-invalid' : '' }}" placeholder="{{ __('Video Link') }}" value="{{ old('link',$video->link) }}" required autofocus>
