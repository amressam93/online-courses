...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $adminCount = User::where('admin',1)->count();    // get count of Admin Role.

        $users = User::where('admin',1)->whereNotIn('id',[$auth_id])->orderBy('id','desc')->paginate(15);   // get all admin Role.

        return view('admin.admins.index', ['users' => $users,'adminCount' => $adminCount]);
