...
(function() {
    ...
    if ($("#dataTableBasic").length && $(document).ready((function() {
        ...
        a && a.addEventListener("click", (function() {
            var e, t, o;
            e = "Nice, you triggered this alert message!", t = "success", (o = document.createElement("div")).innerHTML = '<div class="alert alert-' + t + ' alert-dismissible" role="alert">' + e + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>', n.append(o)
        }))
    }
}(), function() {
            ...
            var a = this,
                ...
                i = setInterval((function() {
                    ...
                    var t = 6e4,
                        ...
                        u = 1 === (c = String(c).length >= 2 ? c : "0" + c) ? "day" : "days",
                        p = 1 === (d = String(d).length >= 2 ? d : "0" + d) ? "hour" : "hours",
                        g = 1 === (h = String(h).length >= 2 ? h : "0" + h) ? "minute" : "minutes",
                        m = 1 === (f = String(f).length >= 2 ? f : "0" + f) ? "second" : "seconds";
                    a.find(".days").text(c), a.find(".hours").text(d), a.find(".minutes").text(h), a.find(".seconds").text(f), a.find(".days_ref").text(u), a.find(".hours_ref").text(p), a.find(".minutes_ref").text(g), a.find(".seconds_ref").text(m)
                }), 1e3)
        }
